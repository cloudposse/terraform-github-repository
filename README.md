...
| <a name="input_teams"></a> [teams](#input\_teams) | A map of teams and their permissions for the repository. This will create [github_repository_collaborators](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/repository_collaborators) resources for each team. | `map(string)` | `{}` | no |
| <a name="input_team_repository"></a> [team_repository](#input\_team_repository) | A map of permissions and their teams for the repository. This will create [github_team_repository](https://registry.terraform.io/providers/integrations/github/latest/docs/resources/team_repository) resources for each team. Format: { permission = [list of teams] } | `map(string)` | `{}` | no |
